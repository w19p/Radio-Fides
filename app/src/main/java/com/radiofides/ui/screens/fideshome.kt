...
fun FidesHome(viewModel: FidesViewModel = viewModel()) {
    ...
    // --- Lógica del RELOJ (24h con Segundos) ---
    var currentTime by remember { mutableStateOf("") }

    LaunchedEffect(Unit) {
        while (true) {
            // HH:mm:ss para 24 horas. "a" opcional si quieres AM/PM
